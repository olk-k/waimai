...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>友情链接</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <label class="radio"><input type="radio" name="hide" value="1" <?php if(($info["hide"]) == "1"): ?>checked="checked"<?php endif; ?> >是</label>
                <label class="radio"><input type="radio" name="hide" value="0" <?php if(empty($info["hide"])): ?>checked="checked"<?php endif; ?>>否</label>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <textarea id="editor" placeholder="连接和内容同时存在时，优先使用连接，当存在子菜单时连接和内容都不显示" name="content" autofocus><?php echo ($info["content"]); ?></textarea>
            </div>
        </div>
        <div class="form-item">
    ...
    <script src="/Public/static/simditor/scripts/module.min.js"></script>
    <script src="/Public/static/simditor/scripts/hotkeys.min.js"></script>
    <script src="/Public/static/simditor/scripts/uploader.min.js"></script>
    <script src="/Public/static/simditor/scripts/simditor.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            new Simditor({
                ...
                upload: {
                    url: '<?php echo U("Conmmon/uploadImg");?>',
                    connectionCount: 1,
