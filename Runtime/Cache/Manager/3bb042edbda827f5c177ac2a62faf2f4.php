...
<body>
    ...
    <div class="tab-wrap">
        <div class="tab-content">
            ...
            <div class="cf">
                <div class="fl">
                    <a class="btn" href="<?php echo U('Site/addJob');?>">新 增</a>
                </div>
...
<!--                <div class="search-form fr cf">
            ...
            <div class="data-table table-striped">
                <table class="">
                    ...
                    <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a href="<?php echo U('Site/editJob/?i='.$vo['id']);?>">编辑</a>
                                    <a href="<?php echo U('Site/del?e=job&id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
                                </td>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Site/job');?>');
    </script>
