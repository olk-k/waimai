...
<body>
    ...
    <form action="<?php echo U('AuthManager/writeGroup');?>" method="POST" class="form-horizontal">
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <?php if(is_array($node_list)): $i = 0; $__LIST__ = $node_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><dl class="checkmod">
                        <dt class="hd">
                        <label class="checkbox"><input class="auth_rules rules_all" type="checkbox" name="rules[]" value="<?php echo ($node["id"]); ?>"><?php echo ($node["title"]); ?>管理</label>
                        </dt>
                        <dd class="bd">
    ...
    <script type="text/javascript">
        + function($){
            ...
            //选中节点
            var checkArray = "<?php echo ($auth_group["rules"]); ?>".split(",");
