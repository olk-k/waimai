    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="<?php echo U('Home/Details/guide?i='.$vo['mid']);?>"><?php echo ($vo["nickname"]); ?></a></td>
                        ...
                        <td>
                            <?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('Member/changeStatus?method=forbidMember&id='.$vo['mid']);?>" class="ajax-get">禁用</a>
                    <?php else: ?>
                    <a href="<?php echo U('Member/changeStatus?method=resumeMember&id='.$vo['mid']);?>" class="ajax-get">启用</a><?php endif; ?>
                    </td>
