...
<body>
    ...
    <div class="tab-wrap">
        ...
        <div class="tab-content">
            <!-- 修改密码表单 -->
            <form action="<?php echo U('');?>" method="post" class="form-horizontal" autocomplete="off">
                <div class="form-item">
                    <label class="item-label">昵称：<span class="check-tips">（请输入新昵称）</span></label>
                    <div class="controls">
                        <input type="text" name="nickname" class="text input-large" autocomplete="off" value="<?php echo ($nickName); ?>"/>
                    </div>
                </div>
                <div class="form-item">
