...
<body>
    ...
    <div class="tools auth-botton">
        ...
        <a url="<?php echo U('AuthManager/del');?>" class="btn ajax-post confirm" target-form="ids" >删 除</a>
    </div>
    <!-- 数据列表 -->
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('AuthManager/editGroup',array('id'=>$vo['id']));?>">编辑</a>
                            ...
                            <a href="<?php echo U('Manager/AuthManager/delGroup/id/'.$vo['id']);?>" class="confirm ajax-get">删除</a>
                        </td>
