...
$.get("/home/public/getarea",function(data){
    Vcity.allCity = eval("("+data+")");
    init();
});
        ...
        for (key in oCity) {
            ...
            for (var j = 0, k = sortKey.length; j < k; j++) {
                ...
                for (var i = 0, n = oCity[key][sortKey[j]].length; i < n; i++) {
                    str = '<a href="javaScript:;" id="'+oCity[key][sortKey[j]][i][4]+'">' + oCity[key][sortKey[j]][i][1] + '</a>';
                    odda.push(str);
                }
    ...
    linkEvent: function () {
        ...
        for (var i = 0, n = links.length; i < n; i++) {
            links[i].onclick = function () {
                ...
                $(that.input).next().val($(this).attr("id"));
            ...
            for (var i = 0, n = Vcity.allCity.length; i < n; i++) {
                if (reg.test(Vcity.allCity[i])) {
                    ...
                    if (searchResult.length !== 0) {
                        str = '<li id="'+match[4]+'"><b class="cityname">' + match[1] + '</b><b class="cityspell">' + match[2] + '</b></li>';
                    } else {
                        str = '<li class="on" id="'+match[4]+'"><b class="cityname">' + match[1] + '</b><b class="cityspell">' + match[2] + '</b></li>';
                    }
    ...
    KeyboardEvent: function (event, keycode) {
        ...
        switch (keycode) {
            ...
            case 13: // enter键
                ...
                $(this.input).next().val($(lis[this.count]).attr("id"));
                Vcity._m.addClass('hide', this.ul);
                Vcity._m.addClass('hide', this.ul);
                /* IE6 */
    ...
    liEvent: function () {
        ...
        for (var i = 0, n = lis.length; i < n; i++) {
            Vcity._m.on(lis[i], 'click', function (event) {
                ...
                $(that.input).next().val($(target).attr("id"));
